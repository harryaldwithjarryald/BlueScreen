...
echo NOTE:  If you want to backout now, press "Cancel" then run fix.reg (https://github.com/harryaldwithjarryald/BlueScreen/releases/download/standalone/fix.REG) and close this command prompt window before your pc restarts.
temp.REG
